...
080492e0 <deregister_tm_clones>:
 80492e0:	b8 cc d1 04 08       	mov    $0x804d1cc,%eax
 80492e5:	3d cc d1 04 08       	cmp    $0x804d1cc,%eax
 ...
 80492fb:	68 cc d1 04 08       	push   $0x804d1cc
...
08049320 <register_tm_clones>:
 8049320:	b8 cc d1 04 08       	mov    $0x804d1cc,%eax
 8049325:	2d cc d1 04 08       	sub    $0x804d1cc,%eax
 ...
 8049347:	50                   	push   %eax
 8049348:	68 cc d1 04 08       	push   $0x804d1cc
...
08049392 <dcCajLbkUw>:
 ...
 80493a7:	90                   	nop
 80493a8:	90                   	nop
 80493a9:	8b 55 0c             	mov    0xc(%ebp),%edx
 80493ac:	89 d0                	mov    %edx,%eax
 80493ae:	c1 e0 02             	shl    $0x2,%eax
 80493b1:	01 c2                	add    %eax,%edx
 80493b3:	8b 45 08             	mov    0x8(%ebp),%eax
 80493b6:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
 80493b9:	8b 45 08             	mov    0x8(%ebp),%eax
 80493bc:	99                   	cltd   
 80493bd:	f7 7d 0c             	idivl  0xc(%ebp)
 80493c0:	29 c1                	sub    %eax,%ecx
 80493c2:	89 c8                	mov    %ecx,%eax
 80493c4:	5d                   	pop    %ebp
 80493c5:	c3                   	ret    
...
080493c6 <smoke>:
 ...
 80493c9:	83 ec 08             	sub    $0x8,%esp
 80493cc:	83 ec 0c             	sub    $0xc,%esp
 80493cf:	68 49 b0 04 08       	push   $0x804b049
 80493d4:	e8 47 fd ff ff       	call   8049120 <puts@plt>
 80493d9:	83 c4 10             	add    $0x10,%esp
 80493dc:	83 ec 0c             	sub    $0xc,%esp
 80493df:	6a 00                	push   $0x0
 80493e1:	e8 d1 09 00 00       	call   8049db7 <validate>
 80493e6:	83 c4 10             	add    $0x10,%esp
 80493e9:	83 ec 0c             	sub    $0xc,%esp
 80493ec:	6a 00                	push   $0x0
 80493ee:	e8 3d fd ff ff       	call   8049130 <exit@plt>

080493f3 <fizz>:
 80493f3:	55                   	push   %ebp
 80493f4:	89 e5                	mov    %esp,%ebp
 80493f6:	83 ec 08             	sub    $0x8,%esp
 80493f9:	8b 55 08             	mov    0x8(%ebp),%edx
 80493fc:	a1 20 d2 04 08       	mov    0x804d220,%eax
 8049401:	39 c2                	cmp    %eax,%edx
 8049403:	75 22                	jne    8049427 <fizz+0x34>
 8049405:	83 ec 08             	sub    $0x8,%esp
 8049408:	ff 75 08             	push   0x8(%ebp)
 804940b:	68 64 b0 04 08       	push   $0x804b064
 8049410:	e8 4b fc ff ff       	call   8049060 <printf@plt>
 8049415:	83 c4 10             	add    $0x10,%esp
 8049418:	83 ec 0c             	sub    $0xc,%esp
 804941b:	6a 01                	push   $0x1
 804941d:	e8 95 09 00 00       	call   8049db7 <validate>
 8049422:	83 c4 10             	add    $0x10,%esp
 8049425:	eb 13                	jmp    804943a <fizz+0x47>
 8049427:	83 ec 08             	sub    $0x8,%esp
 804942a:	ff 75 08             	push   0x8(%ebp)
 804942d:	68 84 b0 04 08       	push   $0x804b084
 ...
 804943f:	e8 ec fc ff ff       	call   8049130 <exit@plt>

08049444 <bang>:
 8049444:	55                   	push   %ebp
 8049445:	89 e5                	mov    %esp,%ebp
 8049447:	83 ec 08             	sub    $0x8,%esp
 804944a:	a1 28 d2 04 08       	mov    0x804d228,%eax
 804944f:	89 c2                	mov    %eax,%edx
 8049451:	a1 20 d2 04 08       	mov    0x804d220,%eax
 8049456:	39 c2                	cmp    %eax,%edx
 8049458:	75 25                	jne    804947f <bang+0x3b>
 804945a:	a1 28 d2 04 08       	mov    0x804d228,%eax
 804945f:	83 ec 08             	sub    $0x8,%esp
 8049462:	50                   	push   %eax
 8049463:	68 a4 b0 04 08       	push   $0x804b0a4
 8049468:	e8 f3 fb ff ff       	call   8049060 <printf@plt>
 804946d:	83 c4 10             	add    $0x10,%esp
 8049470:	83 ec 0c             	sub    $0xc,%esp
 8049473:	6a 02                	push   $0x2
 8049475:	e8 3d 09 00 00       	call   8049db7 <validate>
 804947a:	83 c4 10             	add    $0x10,%esp
 804947d:	eb 16                	jmp    8049495 <bang+0x51>
 804947f:	a1 28 d2 04 08       	mov    0x804d228,%eax
 8049484:	83 ec 08             	sub    $0x8,%esp
 8049487:	50                   	push   %eax
 8049488:	68 c9 b0 04 08       	push   $0x804b0c9
 804948d:	e8 ce fb ff ff       	call   8049060 <printf@plt>
 8049492:	83 c4 10             	add    $0x10,%esp
 8049495:	83 ec 0c             	sub    $0xc,%esp
 8049498:	6a 00                	push   $0x0
 804949a:	e8 91 fc ff ff       	call   8049130 <exit@plt>

0804949f <eval2equal>:
 804949f:	55                   	push   %ebp
 80494a0:	89 e5                	mov    %esp,%ebp
 80494a2:	81 ec 98 00 00 00    	sub    $0x98,%esp
 80494a8:	e8 83 fd ff ff       	call   8049230 <random@plt>
 80494ad:	89 c1                	mov    %eax,%ecx
 80494af:	ba 89 88 88 88       	mov    $0x88888889,%edx
 80494b4:	89 c8                	mov    %ecx,%eax
 80494b6:	f7 ea                	imul   %edx
 80494b8:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 80494bb:	c1 f8 06             	sar    $0x6,%eax
 80494be:	89 c2                	mov    %eax,%edx
 80494c0:	89 c8                	mov    %ecx,%eax
 80494c2:	c1 f8 1f             	sar    $0x1f,%eax
 80494c5:	29 c2                	sub    %eax,%edx
 80494c7:	89 d0                	mov    %edx,%eax
 80494c9:	6b c0 78             	imul   $0x78,%eax,%eax
 80494cc:	29 c1                	sub    %eax,%ecx
 80494ce:	89 c8                	mov    %ecx,%eax
 80494d0:	89 c2                	mov    %eax,%edx
 80494d2:	8d 85 72 ff ff ff    	lea    -0x8e(%ebp),%eax
 80494d8:	01 d0                	add    %edx,%eax
 80494da:	89 45 f4             	mov    %eax,-0xc(%ebp)
 80494dd:	83 ec 04             	sub    $0x4,%esp
 80494e0:	ff 75 0c             	push   0xc(%ebp)
 80494e3:	68 e7 b0 04 08       	push   $0x804b0e7
 80494e8:	ff 75 f4             	push   -0xc(%ebp)
 ...
 80494f8:	ff 75 f4             	push   -0xc(%ebp)
 80494fb:	ff 75 08             	push   0x8(%ebp)
...
08049510 <rumble>:
 ...
 8049516:	a1 20 d2 04 08       	mov    0x804d220,%eax
 804951b:	83 ec 08             	sub    $0x8,%esp
 804951e:	50                   	push   %eax
 804951f:	ff 75 08             	push   0x8(%ebp)
 8049522:	e8 78 ff ff ff       	call   804949f <eval2equal>
 8049527:	83 c4 10             	add    $0x10,%esp
 804952a:	85 c0                	test   %eax,%eax
 804952c:	74 22                	je     8049550 <rumble+0x40>
 804952e:	83 ec 08             	sub    $0x8,%esp
 8049531:	ff 75 08             	push   0x8(%ebp)
 8049534:	68 ec b0 04 08       	push   $0x804b0ec
 ...
 8049553:	ff 75 08             	push   0x8(%ebp)
 8049556:	68 10 b1 04 08       	push   $0x804b110
...
0804956d <test>:
 ...
 8049594:	68 34 b1 04 08       	push   $0x804b134
 ...
 80495a6:	a1 20 d2 04 08       	mov    0x804d220,%eax
 80495ab:	39 c2                	cmp    %eax,%edx
 80495ad:	75 22                	jne    80495d1 <test+0x64>
 80495af:	83 ec 08             	sub    $0x8,%esp
 80495b2:	ff 75 f4             	push   -0xc(%ebp)
 80495b5:	68 5d b1 04 08       	push   $0x804b15d
 ...
 80495d4:	ff 75 f4             	push   -0xc(%ebp)
 80495d7:	68 7a b1 04 08       	push   $0x804b17a
...
080495e7 <testn>:
 ...
 80495ea:	83 ec 38             	sub    $0x38,%esp
 80495ed:	e8 d2 03 00 00       	call   80499c4 <uniqueval>
 80495f2:	89 45 d0             	mov    %eax,-0x30(%ebp)
 ...
 8049620:	a1 20 d2 04 08       	mov    0x804d220,%eax
 8049625:	39 c2                	cmp    %eax,%edx
 8049627:	75 22                	jne    804964b <testn+0x64>
 8049629:	83 ec 08             	sub    $0x8,%esp
 804962c:	ff 75 f4             	push   -0xc(%ebp)
 804962f:	68 98 b1 04 08       	push   $0x804b198
 ...
 804964e:	ff 75 f4             	push   -0xc(%ebp)
 8049651:	68 b8 b1 04 08       	push   $0x804b1b8
...
08049661 <save_char>:
 ...
 804966d:	a1 2c d2 04 08       	mov    0x804d22c,%eax
 ...
 8049688:	8b 15 2c d2 04 08    	mov    0x804d22c,%edx
 804968e:	89 d0                	mov    %edx,%eax
 8049690:	01 c0                	add    %eax,%eax
 8049692:	01 c2                	add    %eax,%edx
 8049694:	0f b6 81 a4 d1 04 08 	movzbl 0x804d1a4(%ecx),%eax
 804969b:	88 82 60 e2 04 08    	mov    %al,0x804e260(%edx)
 80496a1:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
 80496a5:	83 e0 0f             	and    $0xf,%eax
 80496a8:	89 c1                	mov    %eax,%ecx
 80496aa:	8b 15 2c d2 04 08    	mov    0x804d22c,%edx
 80496b0:	89 d0                	mov    %edx,%eax
 80496b2:	01 c0                	add    %eax,%eax
 80496b4:	01 d0                	add    %edx,%eax
 80496b6:	8d 50 01             	lea    0x1(%eax),%edx
 80496b9:	0f b6 81 a4 d1 04 08 	movzbl 0x804d1a4(%ecx),%eax
 80496c0:	88 82 60 e2 04 08    	mov    %al,0x804e260(%edx)
 80496c6:	8b 15 2c d2 04 08    	mov    0x804d22c,%edx
 80496cc:	89 d0                	mov    %edx,%eax
 80496ce:	01 c0                	add    %eax,%eax
 80496d0:	01 d0                	add    %edx,%eax
 80496d2:	83 c0 02             	add    $0x2,%eax
 80496d5:	c6 80 60 e2 04 08 20 	movb   $0x20,0x804e260(%eax)
 80496dc:	a1 2c d2 04 08       	mov    0x804d22c,%eax
 80496e1:	83 c0 01             	add    $0x1,%eax
 80496e4:	a3 2c d2 04 08       	mov    %eax,0x804d22c
 80496e9:	90                   	nop
 80496ea:	c9                   	leave  
 80496eb:	c3                   	ret    
...
080496ec <save_term>:
 ...
 80496ef:	8b 15 2c d2 04 08    	mov    0x804d22c,%edx
 80496f5:	89 d0                	mov    %edx,%eax
 80496f7:	01 c0                	add    %eax,%eax
 80496f9:	01 d0                	add    %edx,%eax
 80496fb:	c6 80 60 e2 04 08 00 	movb   $0x0,0x804e260(%eax)
 8049702:	90                   	nop
 8049703:	5d                   	pop    %ebp
 8049704:	c3                   	ret    
...
08049705 <Gets>:
 ...
 8049711:	c7 05 2c d2 04 08 00 	movl   $0x0,0x804d22c
 8049718:	00 00 00 
 ...
 804973a:	a1 1c d2 04 08       	mov    0x804d21c,%eax
...
0804990d <launcher>:
 ...
 8049916:	a3 30 d2 04 08       	mov    %eax,0x804d230
 804991b:	8b 45 0c             	mov    0xc(%ebp),%eax
 804991e:	a3 34 d2 04 08       	mov    %eax,0x804d234
 ...
 8049978:	a3 40 e2 04 08       	mov    %eax,0x804e240
 804997d:	8b 15 40 e2 04 08    	mov    0x804e240,%edx
 8049983:	89 e0                	mov    %esp,%eax
 8049985:	89 d4                	mov    %edx,%esp
 8049987:	89 c2                	mov    %eax,%edx
 8049989:	89 15 38 d2 04 08    	mov    %edx,0x804d238
 804998f:	8b 15 34 d2 04 08    	mov    0x804d234,%edx
 8049995:	a1 30 d2 04 08       	mov    0x804d230,%eax
 804999a:	83 ec 08             	sub    $0x8,%esp
 804999d:	52                   	push   %edx
 804999e:	50                   	push   %eax
 804999f:	e8 bf fe ff ff       	call   8049863 <launch>
 80499a4:	83 c4 10             	add    $0x10,%esp
 80499a7:	a1 38 d2 04 08       	mov    0x804d238,%eax
 80499ac:	89 c4                	mov    %eax,%esp
 80499ae:	83 ec 08             	sub    $0x8,%esp
 80499b1:	68 00 00 10 00       	push   $0x100000
 80499b6:	ff 75 f4             	push   -0xc(%ebp)
...
080499e2 <main>:
 ...
 8049a41:	a1 00 d2 04 08       	mov    0x804d200,%eax
 8049a46:	a3 1c d2 04 08       	mov    %eax,0x804d21c
 ...
 8049a60:	8b 04 85 e0 b3 04 08 	mov    0x804b3e0(,%eax,4),%eax
 ...
 8049af6:	68 90 b3 04 08       	push   $0x804b390
 8049afb:	ff 73 04             	push   0x4(%ebx)
 8049afe:	ff 33                	push   (%ebx)
 ...
 8049b15:	a1 10 d2 04 08       	mov    0x804d210,%eax
 ...
 8049b26:	50                   	push   %eax
 8049b27:	68 98 b3 04 08       	push   $0x804b398
...
08049c3a <getbuf>:
 ...
 8049c3d:	83 ec 58             	sub    $0x58,%esp
 8049c40:	83 ec 0c             	sub    $0xc,%esp
 8049c43:	8d 45 ad             	lea    -0x53(%ebp),%eax
 8049c46:	50                   	push   %eax
...
08049c56 <getbufn>:
 ...
 8049c59:	81 ec f8 02 00 00    	sub    $0x2f8,%esp
 8049c5f:	83 ec 0c             	sub    $0xc,%esp
 8049c62:	8d 85 0d fd ff ff    	lea    -0x2f3(%ebp),%eax
 8049c68:	50                   	push   %eax
...
08049c78 <initialize_bomb>:
 ...
 8049c88:	a1 18 d2 04 08       	mov    0x804d218,%eax
 ...
 8049c9e:	a1 14 d2 04 08       	mov    0x804d214,%eax
 ...
 8049cc9:	68 1c b4 04 08       	push   $0x804b41c
 ...
 8049cec:	8b 04 85 40 d2 04 08 	mov    0x804d240(,%eax,4),%eax
 ...
 8049d1a:	8b 04 85 40 d2 04 08 	mov    0x804d240(,%eax,4),%eax
 ...
 8049d34:	50                   	push   %eax
 8049d35:	68 54 b4 04 08       	push   $0x804b454
 ...
 8049d4e:	8b 04 85 40 d2 04 08 	mov    0x804d240(,%eax,4),%eax
 ...
 8049d68:	8b 04 85 40 d2 04 08 	mov    0x804d240(,%eax,4),%eax
 ...
 8049d9c:	50                   	push   %eax
 8049d9d:	68 8f b4 04 08       	push   $0x804b48f
...
08049db7 <validate>:
 ...
 8049ded:	68 d0 b4 04 08       	push   $0x804b4d0
 ...
 8049dff:	c7 05 24 d2 04 08 01 	movl   $0x1,0x804d224
 8049e06:	00 00 00 
 8049e09:	8b 45 08             	mov    0x8(%ebp),%eax
 8049e0c:	8b 04 85 b4 d1 04 08 	mov    0x804d1b4(,%eax,4),%eax
 8049e13:	8d 50 ff             	lea    -0x1(%eax),%edx
 8049e16:	8b 45 08             	mov    0x8(%ebp),%eax
 8049e19:	89 14 85 b4 d1 04 08 	mov    %edx,0x804d1b4(,%eax,4)
 8049e20:	8b 45 08             	mov    0x8(%ebp),%eax
 8049e23:	8b 04 85 b4 d1 04 08 	mov    0x804d1b4(,%eax,4),%eax
 8049e2a:	85 c0                	test   %eax,%eax
 8049e2c:	7e 15                	jle    8049e43 <validate+0x8c>
 8049e2e:	83 ec 0c             	sub    $0xc,%esp
 8049e31:	68 f6 b4 04 08       	push   $0x804b4f6
 ...
 8049e7d:	68 08 b5 04 08       	push   $0x804b508
 ...
 8049e8f:	a1 20 d2 04 08       	mov    0x804d220,%eax
 8049e94:	83 ec 0c             	sub    $0xc,%esp
 8049e97:	68 60 e2 04 08       	push   $0x804e260
 8049e9c:	50                   	push   %eax
 8049e9d:	ff 75 08             	push   0x8(%ebp)
 8049ea0:	68 3f b5 04 08       	push   $0x804b53f
 8049ea5:	8d 85 f4 df ff ff    	lea    -0x200c(%ebp),%eax
 8049eab:	50                   	push   %eax
 8049eac:	e8 4f f3 ff ff       	call   8049200 <sprintf@plt>
 8049eb1:	83 c4 20             	add    $0x20,%esp
 8049eb4:	a1 10 d2 04 08       	mov    0x804d210,%eax
 ...
 8049ede:	68 48 b5 04 08       	push   $0x804b548
...
08049f16 <sigalrm_handler>:
 ...
 8049f21:	68 c0 b5 04 08       	push   $0x804b5c0
...
0804a0a6 <rio_writen>:
 ...
 804a0bd:	ff 75 f4             	push   -0xc(%ebp)
 804a0c0:	ff 75 ec             	push   -0x14(%ebp)
 804a0c3:	ff 75 08             	push   0x8(%ebp)
...
0804a10a <urlencode>:
 ...
 804a1e2:	50                   	push   %eax
 804a1e3:	68 e4 b5 04 08       	push   $0x804b5e4
...
0804a24c <submitr>:
 ...
 804a2e7:	ff 75 08             	push   0x8(%ebp)
 804a2ea:	68 ec b5 04 08       	push   $0x804b5ec
 804a2ef:	ff 75 20             	push   0x20(%ebp)
 804a2f2:	e8 09 ef ff ff       	call   8049200 <sprintf@plt>
 804a2f7:	83 c4 10             	add    $0x10,%esp
 804a2fa:	83 ec 0c             	sub    $0xc,%esp
 804a2fd:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a378:	50                   	push   %eax
 804a379:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a38b:	ff 75 08             	push   0x8(%ebp)
 804a38e:	68 18 b6 04 08       	push   $0x804b618
 804a393:	ff 75 20             	push   0x20(%ebp)
 804a396:	e8 65 ee ff ff       	call   8049200 <sprintf@plt>
 804a39b:	83 c4 10             	add    $0x10,%esp
 804a39e:	83 ec 0c             	sub    $0xc,%esp
 804a3a1:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a3b9:	ff 75 1c             	push   0x1c(%ebp)
 ...
 804a3ca:	ff 75 10             	push   0x10(%ebp)
 ...
 804a3da:	ff 75 14             	push   0x14(%ebp)
 ...
 804a3ea:	ff 75 18             	push   0x18(%ebp)
 ...
 804a479:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a4af:	50                   	push   %eax
 804a4b0:	ff 75 1c             	push   0x1c(%ebp)
 ...
 804a4c2:	bb 40 b6 04 08       	mov    $0x804b640,%ebx
 ...
 804a4f5:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a513:	50                   	push   %eax
 804a514:	ff 75 18             	push   0x18(%ebp)
 804a517:	ff 75 14             	push   0x14(%ebp)
 804a51a:	ff 75 10             	push   0x10(%ebp)
 804a51d:	68 84 b6 04 08       	push   $0x804b684
 ...
 804a54d:	50                   	push   %eax
 804a54e:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a5af:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a5c7:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a661:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a68d:	50                   	push   %eax
 804a68e:	68 ce b6 04 08       	push   $0x804b6ce
 ...
 804a768:	ff 75 e4             	push   -0x1c(%ebp)
 ...
 804a780:	68 0d b7 04 08       	push   $0x804b70d
 ...
 804a825:	ff 75 e4             	push   -0x1c(%ebp)
...
0804a8c4 <init_driver>:
 ...
 804a8ca:	c7 45 f4 13 b7 04 08 	movl   $0x804b713,-0xc(%ebp)
 ...
 804a98a:	ff 75 f4             	push   -0xc(%ebp)
 804a98d:	68 ec b5 04 08       	push   $0x804b5ec
 804a992:	ff 75 08             	push   0x8(%ebp)
 804a995:	e8 66 e8 ff ff       	call   8049200 <sprintf@plt>
 804a99a:	83 c4 10             	add    $0x10,%esp
 804a99d:	83 ec 0c             	sub    $0xc,%esp
 804a9a0:	ff 75 ec             	push   -0x14(%ebp)
 ...
 804aa1b:	50                   	push   %eax
 804aa1c:	ff 75 ec             	push   -0x14(%ebp)
 ...
 804aa2b:	ff 75 f0             	push   -0x10(%ebp)
 804aa2e:	ff 75 f4             	push   -0xc(%ebp)
 804aa31:	68 24 b7 04 08       	push   $0x804b724
 804aa36:	ff 75 08             	push   0x8(%ebp)
 804aa39:	e8 c2 e7 ff ff       	call   8049200 <sprintf@plt>
 804aa3e:	83 c4 10             	add    $0x10,%esp
 804aa41:	83 ec 0c             	sub    $0xc,%esp
 804aa44:	ff 75 ec             	push   -0x14(%ebp)
 ...
 804aa59:	ff 75 ec             	push   -0x14(%ebp)
...
0804aa77 <driver_post>:
 ...
 804aa86:	ff 75 0c             	push   0xc(%ebp)
 804aa89:	68 4d b7 04 08       	push   $0x804b74d
 ...
 804aabf:	ff 75 14             	push   0x14(%ebp)
 804aac2:	ff 75 0c             	push   0xc(%ebp)
 804aac5:	68 64 b7 04 08       	push   $0x804b764
 804aaca:	ff 75 08             	push   0x8(%ebp)
 804aacd:	68 6b b7 04 08       	push   $0x804b76b
 804aad2:	68 03 d9 00 00       	push   $0xd903
 804aad7:	68 13 b7 04 08       	push   $0x804b713
...
0804abc0 <__libc_csu_init>:
 ...
 804abf3:	55                   	push   %ebp
 804abf4:	ff 74 24 2c          	push   0x2c(%esp)
 804abf8:	ff 74 24 2c          	push   0x2c(%esp)
